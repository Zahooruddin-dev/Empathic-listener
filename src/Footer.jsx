		...
		<footer className='bg-rgb(16, 25, 46) text-white py-4 text-center shadow-lg w-full'>
			<div className='container mx-auto px-4'>
				...
				<p className='text-sm text-gray-300 mb-4'>
					Empathic listener has been selected for the Gemini API Developer
					Competition and is recognized by Google AI.
				</p>
				...
				<p className='text-xs text-gray-500'>
					&copy; 2025 Empathic listener. All rights reserved.
				</p>
			</div>
		</footer>
	);
